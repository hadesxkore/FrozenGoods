    ...
    >
      ...
      {isMobile && (
        <Button
          variant="default"
          size="icon"
          className="absolute -right-12 top-4 rounded-full shadow-md bg-primary hover:bg-primary/90 text-primary-foreground"
          onClick={handleToggle}
        >
      ...
      <div className="flex flex-col h-full p-4">
        ...
        <div className="flex items-center justify-between mb-8 mt-2">
          <div className="flex items-center gap-2">
            ...
            {expanded && (
              <span className="text-lg font-bold tracking-tight">FrozenGoods</span>
            )}
          </div>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Link
                      to={item.path}
                      className={cn(
                        "flex items-center justify-center h-12 w-12 rounded-lg mb-1 transition-all mx-auto",
                        isActive 
                          ? "bg-sidebar-primary text-sidebar-primary-foreground" 
                          : "text-sidebar-foreground hover:bg-sidebar-accent/30"
                      )}
